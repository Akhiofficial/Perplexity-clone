    ...
    <div className="flex flex-col min-h-screen w-full bg-brand-bg text-brand-text selection:bg-brand-primary/30 font-sans antialiased">
      ...
      <header className="flex items-center justify-between px-6 py-6 w-full max-w-7xl mx-auto z-10">
        ...
        <div className="text-[13px]">
          ...
          <Link to="/login" className="text-brand-text hover:text-brand-primary font-semibold transition-colors ml-1">
            Log in
          </Link>
        </div>
      </header>
        ...
        <div className="w-full max-w-[420px] text-center">
          <div className="mb-10">
            ...
            <p className="text-gray-400 text-base md:text-lg leading-relaxed max-w-[340px] mx-auto">
              Join Perplexity AI and start building your future.
            </p>
          </div>
          ...
          <p className="mt-8 text-[12px] text-gray-500 leading-relaxed">
            ...
            <Link to="#" className="text-gray-400 hover:text-brand-text underline underline-offset-4 decoration-brand-surface">Terms</Link> and <Link to="#" className="text-gray-400 hover:text-brand-text underline underline-offset-4 decoration-brand-surface">Privacy Policy</Link>.
          </p>
        </div>
      </main>
